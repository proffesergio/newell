"""Schema creation for the auth service (no Alembic — see task brief).

Run directly to create tables against the configured Postgres DSN:

    python -m auth.db_init
"""
...
from auth import models  # noqa: F401  registers tables on Base.metadata
