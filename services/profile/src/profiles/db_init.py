"""Schema creation for the profile service (no Alembic — see task brief).

Run directly to create tables against the configured Postgres DSN:

    python -m profiles.db_init
"""
...
from profiles import models  # noqa: F401  registers tables on Base.metadata
