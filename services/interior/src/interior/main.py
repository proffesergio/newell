...
from interior.db_init import create_all
from interior.routes import router
...
def create_app() -> FastAPI:
    configure_logging()
    app = FastAPI(title="Newell Interior Design Service", version="0.1.0", lifespan=_lifespan)
